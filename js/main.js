...
var pizzaElementGenerator = function(i) {
  ...
  pizzaContainer.classList.add("med-pizza"); //added default pizza size class
...
var resizePizzas = function(size) {
  ...
  // change pizza container classes to reflect pizza size
  function changePizzaSizes(size) {
    var newWidth;
    switch(size) {
      case "1":
      //newWidth = 25;
      newWidth = "randomPizzaContainer small-pizza";
      break;
      case "2":
      //newWidth = 33.3;
      newWidth = "randomPizzaContainer med-pizza";
      break;
      case "3":
      //newWidth = 50;
      newWidth = "randomPizzaContainer lrg-pizza";
      break;
      default:
    ...
    for (var i = 0; i < randomPizzaContainer.length; i++) {
      ...
      randomPizzaContainer[i].className = newWidth;
    }
...
// Generates the sliding pizzas when the page loads based on page height
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var spacing = 256;
  var numberOfPizzas = Math.round(window.innerHeight / spacing) * cols;
  ...
  for (var i = 0; i < numberOfPizzas; i++) {
    ...
    elem.style.left = ((i % cols) * spacing) + 'px';
